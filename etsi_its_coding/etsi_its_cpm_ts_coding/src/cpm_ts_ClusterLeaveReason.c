...
#include "etsi_its_cpm_ts_coding/cpm_ts_ClusterLeaveReason.h"
...
const asn_INTEGER_specifics_t asn_SPC_cpm_ts_ClusterLeaveReason_specs_1 = {
	asn_MAP_cpm_ts_ClusterLeaveReason_value2enum_1,	/* "tag" => N; sorted by tag */
	asn_MAP_cpm_ts_ClusterLeaveReason_enum2value_1,	/* N => "tag"; sorted by N */
...
asn_TYPE_descriptor_t asn_DEF_cpm_ts_ClusterLeaveReason = {
	...
	sizeof(asn_DEF_cpm_ts_ClusterLeaveReason_tags_1)
		/sizeof(asn_DEF_cpm_ts_ClusterLeaveReason_tags_1[0]), /* 1 */
	asn_DEF_cpm_ts_ClusterLeaveReason_tags_1,	/* Same as above */
	sizeof(asn_DEF_cpm_ts_ClusterLeaveReason_tags_1)
		/sizeof(asn_DEF_cpm_ts_ClusterLeaveReason_tags_1[0]), /* 1 */
	{
	...
	&asn_SPC_cpm_ts_ClusterLeaveReason_specs_1	/* Additional specs */
};
