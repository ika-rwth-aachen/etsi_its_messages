...
#ifndef	_cpm_ts_Direction_H_
#define	_cpm_ts_Direction_H_
...
/* Dependencies */
typedef enum cpm_ts_Direction {
	cpm_ts_Direction_sameDirection	= 0,
	cpm_ts_Direction_oppositeDirection	= 1,
	cpm_ts_Direction_bothDirections	= 2,
	cpm_ts_Direction_unavailable	= 3
} e_cpm_ts_Direction;
...
/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_cpm_ts_Direction;
