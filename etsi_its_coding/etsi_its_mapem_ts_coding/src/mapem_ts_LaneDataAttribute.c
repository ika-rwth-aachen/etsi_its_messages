...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
asn_per_constraints_t asn_PER_type_mapem_ts_LaneDataAttribute_constr_1 CC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_mapem_ts_regional_8[] = {
	{ ATF_POINTER, 0, 0,
		...
		0,
		&asn_DEF_mapem_ts_Reg_LaneDataAttribute,
		0,
		{
...
static asn_SET_OF_specifics_t asn_SPC_mapem_ts_regional_specs_8 = {
	sizeof(struct mapem_ts_LaneDataAttribute__regional),
	offsetof(struct mapem_ts_LaneDataAttribute__regional, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_mapem_ts_LaneDataAttribute_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct mapem_ts_LaneDataAttribute, choice.laneCrownPointCenter),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct mapem_ts_LaneDataAttribute, choice.laneCrownPointLeft),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct mapem_ts_LaneDataAttribute, choice.laneCrownPointRight),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct mapem_ts_LaneDataAttribute, choice.laneAngle),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct mapem_ts_LaneDataAttribute, choice.speedLimits),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct mapem_ts_LaneDataAttribute, choice.regional),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		0,
...
static const asn_TYPE_tag2member_t asn_MAP_mapem_ts_LaneDataAttribute_tag2el_1[] = {
...
asn_CHOICE_specifics_t asn_SPC_mapem_ts_LaneDataAttribute_specs_1 = {
	sizeof(struct mapem_ts_LaneDataAttribute),
	offsetof(struct mapem_ts_LaneDataAttribute, _asn_ctx),
	offsetof(struct mapem_ts_LaneDataAttribute, present),
	sizeof(((struct mapem_ts_LaneDataAttribute *)0)->present),
	asn_MAP_mapem_ts_LaneDataAttribute_tag2el_1,
	7,	/* Count of tags in the map */
	0, 0,
	7	/* Extensions start */
};
asn_TYPE_descriptor_t asn_DEF_mapem_ts_LaneDataAttribute = {
	"LaneDataAttribute",
	"LaneDataAttribute",
	&asn_OP_CHOICE,
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_mapem_ts_LaneDataAttribute_constr_1,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
	...
	7,	/* Elements count */
	&asn_SPC_mapem_ts_LaneDataAttribute_specs_1	/* Additional specs */
};
