...
#ifndef	_mapem_ts_NodeXY_H_
#define	_mapem_ts_NodeXY_H_
...
struct mapem_ts_NodeAttributeSetXY;

/* mapem_ts_NodeXY */
typedef struct mapem_ts_NodeXY {
	mapem_ts_NodeOffsetPointXY_t	 delta;
	struct mapem_ts_NodeAttributeSetXY	*attributes;	/* OPTIONAL */
	/*
...
/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_mapem_ts_NodeXY;
extern asn_SEQUENCE_specifics_t asn_SPC_mapem_ts_NodeXY_specs_1;
extern asn_TYPE_member_t asn_MBR_mapem_ts_NodeXY_1[2];
