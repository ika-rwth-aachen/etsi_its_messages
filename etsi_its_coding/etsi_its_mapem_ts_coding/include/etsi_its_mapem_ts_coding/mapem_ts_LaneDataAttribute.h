...
#ifndef	_mapem_ts_LaneDataAttribute_H_
#define	_mapem_ts_LaneDataAttribute_H_


#include <etsi_its_mapem_ts_coding/asn_application.h>

/* Including external dependencies */
#include "etsi_its_mapem_ts_coding/mapem_ts_DeltaAngle.h"
#include "etsi_its_mapem_ts_coding/mapem_ts_RoadwayCrownAngle.h"
#include "etsi_its_mapem_ts_coding/mapem_ts_MergeDivergeNodeAngle.h"
...
/* Dependencies */
typedef enum mapem_ts_LaneDataAttribute_PR {
	mapem_ts_LaneDataAttribute_PR_NOTHING,	/* No components present */
	...
	mapem_ts_LaneDataAttribute_PR_regional
	/* Extensions may appear below */
	
} mapem_ts_LaneDataAttribute_PR;

/* Forward declarations */
struct mapem_ts_Reg_LaneDataAttribute;

/* mapem_ts_LaneDataAttribute */
typedef struct mapem_ts_LaneDataAttribute {
	mapem_ts_LaneDataAttribute_PR present;
	union mapem_ts_LaneDataAttribute_u {
		...
		struct mapem_ts_LaneDataAttribute__regional {
			A_SEQUENCE_OF(struct mapem_ts_Reg_LaneDataAttribute) list;
	...
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} mapem_ts_LaneDataAttribute_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_mapem_ts_LaneDataAttribute;
extern asn_CHOICE_specifics_t asn_SPC_mapem_ts_LaneDataAttribute_specs_1;
extern asn_TYPE_member_t asn_MBR_mapem_ts_LaneDataAttribute_1[7];
extern asn_per_constraints_t asn_PER_type_mapem_ts_LaneDataAttribute_constr_1;
...
#endif	/* _mapem_ts_LaneDataAttribute_H_ */
