...
#include <etsi_its_mapem_coding/ber_tlv_length.h>
#include <etsi_its_mapem_coding/ber_tlv_tag.h>
...
#include <etsi_its_mapem_coding/ber_decoder.h>  /* Basic Encoding Rules decoder */
#include <etsi_its_mapem_coding/der_encoder.h>  /* Distinguished Encoding Rules encoder */
#else
...
#include <etsi_its_mapem_coding/xer_decoder.h>  /* Decoder of XER (XML, text) */
#include <etsi_its_mapem_coding/xer_encoder.h>  /* Encoder into XER (XML, text) */
#else
...
#include <etsi_its_mapem_coding/jer_encoder.h>  /* Encoder into JER (JSON, text) */
#else
typedef void (jer_type_encoder_f)(void);
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */

#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
#include <etsi_its_mapem_coding/per_decoder.h>  /* Packet Encoding Rules decoder */
#include <etsi_its_mapem_coding/per_encoder.h>  /* Packet Encoding Rules encoder */
#else
typedef void (per_type_decoder_f)(void);
typedef void (per_type_encoder_f)(void);
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */

#include <etsi_its_mapem_coding/constraints.h>  /* Subtype constraints support */

#if !defined(ASN_DISABLE_RFILL_SUPPORT)
#include <etsi_its_mapem_coding/asn_random_fill.h>  /* Random structures support */
#else
typedef void (asn_random_fill_f)(void);
#endif  /* !defined(ASN_DISABLE_RFILL_SUPPORT) */

#if !defined(ASN_DISABLE_OER_SUPPORT)
#include <etsi_its_mapem_coding/oer_decoder.h>  /* Octet Encoding Rules encoder */
#include <etsi_its_mapem_coding/oer_encoder.h>  /* Octet Encoding Rules encoder */
#else
