...
#ifndef	_vam_ts_RadialShapes_H_
#define	_vam_ts_RadialShapes_H_
...
/* vam_ts_RadialShapes */
typedef struct vam_ts_RadialShapes {
	...
	vam_ts_CartesianCoordinateSmall_t	*zCoordinate;	/* OPTIONAL */
	vam_ts_RadialShapesList_t	 radialShapesList;
	
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} vam_ts_RadialShapes_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_vam_ts_RadialShapes;
extern asn_SEQUENCE_specifics_t asn_SPC_vam_ts_RadialShapes_specs_1;
extern asn_TYPE_member_t asn_MBR_vam_ts_RadialShapes_1[5];

#ifdef __cplusplus
}
#endif

#endif	/* _vam_ts_RadialShapes_H_ */
