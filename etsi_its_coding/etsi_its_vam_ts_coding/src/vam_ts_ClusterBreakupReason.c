...
const asn_INTEGER_specifics_t asn_SPC_vam_ts_ClusterBreakupReason_specs_1 = {
	asn_MAP_vam_ts_ClusterBreakupReason_value2enum_1,	/* "tag" => N; sorted by tag */
	asn_MAP_vam_ts_ClusterBreakupReason_enum2value_1,	/* N => "tag"; sorted by N */
...
asn_TYPE_descriptor_t asn_DEF_vam_ts_ClusterBreakupReason = {
	...
	sizeof(asn_DEF_vam_ts_ClusterBreakupReason_tags_1)
		/sizeof(asn_DEF_vam_ts_ClusterBreakupReason_tags_1[0]), /* 1 */
	asn_DEF_vam_ts_ClusterBreakupReason_tags_1,	/* Same as above */
	sizeof(asn_DEF_vam_ts_ClusterBreakupReason_tags_1)
		/sizeof(asn_DEF_vam_ts_ClusterBreakupReason_tags_1[0]), /* 1 */
	{
	...
	&asn_SPC_vam_ts_ClusterBreakupReason_specs_1	/* Additional specs */
};
