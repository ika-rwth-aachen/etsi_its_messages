...
int
vam_ts_TimestampIts_constraint(const asn_TYPE_descriptor_t *td, const void *sptr,
...
asn_TYPE_descriptor_t asn_DEF_vam_ts_TimestampIts = {
	...
	sizeof(asn_DEF_vam_ts_TimestampIts_tags_1)
		/sizeof(asn_DEF_vam_ts_TimestampIts_tags_1[0]), /* 1 */
	asn_DEF_vam_ts_TimestampIts_tags_1,	/* Same as above */
	sizeof(asn_DEF_vam_ts_TimestampIts_tags_1)
		/sizeof(asn_DEF_vam_ts_TimestampIts_tags_1[0]), /* 1 */
	{
