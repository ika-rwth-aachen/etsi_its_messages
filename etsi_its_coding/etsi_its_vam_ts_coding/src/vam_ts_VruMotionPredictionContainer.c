...
asn_TYPE_member_t asn_MBR_vam_ts_VruMotionPredictionContainer_1[] = {
	{ ATF_POINTER, 7, offsetof(struct vam_ts_VruMotionPredictionContainer, pathHistory),
	...
	{ ATF_POINTER, 6, offsetof(struct vam_ts_VruMotionPredictionContainer, pathPrediction),
	...
	{ ATF_POINTER, 5, offsetof(struct vam_ts_VruMotionPredictionContainer, safeDistance),
	...
	{ ATF_POINTER, 4, offsetof(struct vam_ts_VruMotionPredictionContainer, trajectoryInterceptionIndication),
	...
	{ ATF_POINTER, 3, offsetof(struct vam_ts_VruMotionPredictionContainer, accelerationChangeIndication),
	...
	{ ATF_POINTER, 2, offsetof(struct vam_ts_VruMotionPredictionContainer, headingChangeIndication),
	...
	{ ATF_POINTER, 1, offsetof(struct vam_ts_VruMotionPredictionContainer, stabilityChangeIndication),
...
static const int asn_MAP_vam_ts_VruMotionPredictionContainer_oms_1[] = { 0, 1, 2, 3, 4, 5, 6 };
...
asn_SEQUENCE_specifics_t asn_SPC_vam_ts_VruMotionPredictionContainer_specs_1 = {
	sizeof(struct vam_ts_VruMotionPredictionContainer),
	offsetof(struct vam_ts_VruMotionPredictionContainer, _asn_ctx),
	asn_MAP_vam_ts_VruMotionPredictionContainer_tag2el_1,
	7,	/* Count of tags in the map */
	asn_MAP_vam_ts_VruMotionPredictionContainer_oms_1,	/* Optional members */
	7, 0,	/* Root/Additions */
...
asn_TYPE_descriptor_t asn_DEF_vam_ts_VruMotionPredictionContainer = {
	...
	sizeof(asn_DEF_vam_ts_VruMotionPredictionContainer_tags_1)
		/sizeof(asn_DEF_vam_ts_VruMotionPredictionContainer_tags_1[0]), /* 1 */
	asn_DEF_vam_ts_VruMotionPredictionContainer_tags_1,	/* Same as above */
	sizeof(asn_DEF_vam_ts_VruMotionPredictionContainer_tags_1)
		/sizeof(asn_DEF_vam_ts_VruMotionPredictionContainer_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	7,	/* Elements count */
	&asn_SPC_vam_ts_VruMotionPredictionContainer_specs_1	/* Additional specs */
};
