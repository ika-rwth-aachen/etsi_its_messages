...
asn_TYPE_member_t asn_MBR_vam_ts_VruProfileAndSubprofile_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct vam_ts_VruProfileAndSubprofile, choice.pedestrian),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct vam_ts_VruProfileAndSubprofile, choice.bicyclistAndLightVruVehicle),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct vam_ts_VruProfileAndSubprofile, choice.motorcyclist),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct vam_ts_VruProfileAndSubprofile, choice.animal),
...
asn_CHOICE_specifics_t asn_SPC_vam_ts_VruProfileAndSubprofile_specs_1 = {
	sizeof(struct vam_ts_VruProfileAndSubprofile),
	offsetof(struct vam_ts_VruProfileAndSubprofile, _asn_ctx),
	offsetof(struct vam_ts_VruProfileAndSubprofile, present),
	sizeof(((struct vam_ts_VruProfileAndSubprofile *)0)->present),
...
asn_TYPE_descriptor_t asn_DEF_vam_ts_VruProfileAndSubprofile = {
	...
	4,	/* Elements count */
	&asn_SPC_vam_ts_VruProfileAndSubprofile_specs_1	/* Additional specs */
};
