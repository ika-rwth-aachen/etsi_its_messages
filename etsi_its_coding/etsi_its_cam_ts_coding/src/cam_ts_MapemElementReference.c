...
asn_TYPE_member_t asn_MBR_cam_ts_MapemElementReference_1[] = {
	{ ATF_POINTER, 3, offsetof(struct cam_ts_MapemElementReference, mapReference),
	...
	{ ATF_POINTER, 2, offsetof(struct cam_ts_MapemElementReference, laneIds),
	...
	{ ATF_POINTER, 1, offsetof(struct cam_ts_MapemElementReference, connectionIds),
...
static const int asn_MAP_cam_ts_MapemElementReference_oms_1[] = { 0, 1, 2 };
...
asn_SEQUENCE_specifics_t asn_SPC_cam_ts_MapemElementReference_specs_1 = {
	sizeof(struct cam_ts_MapemElementReference),
	offsetof(struct cam_ts_MapemElementReference, _asn_ctx),
	asn_MAP_cam_ts_MapemElementReference_tag2el_1,
	3,	/* Count of tags in the map */
	asn_MAP_cam_ts_MapemElementReference_oms_1,	/* Optional members */
	3, 0,	/* Root/Additions */
...
asn_TYPE_descriptor_t asn_DEF_cam_ts_MapemElementReference = {
	...
	sizeof(asn_DEF_cam_ts_MapemElementReference_tags_1)
		/sizeof(asn_DEF_cam_ts_MapemElementReference_tags_1[0]), /* 1 */
	asn_DEF_cam_ts_MapemElementReference_tags_1,	/* Same as above */
	sizeof(asn_DEF_cam_ts_MapemElementReference_tags_1)
		/sizeof(asn_DEF_cam_ts_MapemElementReference_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	3,	/* Elements count */
	&asn_SPC_cam_ts_MapemElementReference_specs_1	/* Additional specs */
};
