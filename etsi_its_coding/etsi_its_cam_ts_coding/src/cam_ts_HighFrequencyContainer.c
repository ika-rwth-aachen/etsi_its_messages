...
asn_TYPE_member_t asn_MBR_cam_ts_HighFrequencyContainer_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct cam_ts_HighFrequencyContainer, choice.basicVehicleContainerHighFrequency),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct cam_ts_HighFrequencyContainer, choice.rsuContainerHighFrequency),
...
asn_CHOICE_specifics_t asn_SPC_cam_ts_HighFrequencyContainer_specs_1 = {
	sizeof(struct cam_ts_HighFrequencyContainer),
	offsetof(struct cam_ts_HighFrequencyContainer, _asn_ctx),
	offsetof(struct cam_ts_HighFrequencyContainer, present),
	sizeof(((struct cam_ts_HighFrequencyContainer *)0)->present),
...
asn_TYPE_descriptor_t asn_DEF_cam_ts_HighFrequencyContainer = {
	...
	2,	/* Elements count */
	&asn_SPC_cam_ts_HighFrequencyContainer_specs_1	/* Additional specs */
};
