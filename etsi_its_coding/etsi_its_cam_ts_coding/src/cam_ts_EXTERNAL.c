...
#include "etsi_its_cam_ts_coding/cam_ts_EXTERNAL.h"
...
static asn_TYPE_member_t asn_MBR_cam_ts_encoding_5[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct cam_ts_EXTERNAL__encoding, choice.single_ASN1_type),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct cam_ts_EXTERNAL__encoding, choice.octet_aligned),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct cam_ts_EXTERNAL__encoding, choice.arbitrary),
...
static asn_CHOICE_specifics_t asn_SPC_cam_ts_encoding_specs_5 = {
	sizeof(struct cam_ts_EXTERNAL__encoding),
	offsetof(struct cam_ts_EXTERNAL__encoding, _asn_ctx),
	offsetof(struct cam_ts_EXTERNAL__encoding, present),
	sizeof(((struct cam_ts_EXTERNAL__encoding *)0)->present),
...
asn_TYPE_descriptor_t asn_DEF_cam_ts_encoding_5 = {
	"encoding",
	"encoding",
	&asn_OP_CHOICE,
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_cam_ts_encoding_constr_5,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
	...
	3,	/* Elements count */
	&asn_SPC_cam_ts_encoding_specs_5	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_cam_ts_EXTERNAL_1[] = {
	{ ATF_POINTER, 3, offsetof(struct cam_ts_EXTERNAL, direct_reference),
	...
	{ ATF_POINTER, 2, offsetof(struct cam_ts_EXTERNAL, indirect_reference),
	...
	{ ATF_POINTER, 1, offsetof(struct cam_ts_EXTERNAL, data_value_descriptor),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct cam_ts_EXTERNAL, encoding),
...
static const int asn_MAP_cam_ts_EXTERNAL_oms_1[] = { 0, 1, 2 };
...
static asn_SEQUENCE_specifics_t asn_SPC_cam_ts_EXTERNAL_specs_1 = {
	sizeof(struct cam_ts_EXTERNAL),
	offsetof(struct cam_ts_EXTERNAL, _asn_ctx),
	asn_MAP_cam_ts_EXTERNAL_tag2el_1,
	6,	/* Count of tags in the map */
	asn_MAP_cam_ts_EXTERNAL_oms_1,	/* Optional members */
	3, 0,	/* Root/Additions */
...
asn_TYPE_descriptor_t asn_DEF_cam_ts_EXTERNAL = {
	...
	sizeof(asn_DEF_cam_ts_EXTERNAL_tags_1)
		/sizeof(asn_DEF_cam_ts_EXTERNAL_tags_1[0]) - 1, /* 1 */
	asn_DEF_cam_ts_EXTERNAL_tags_1,	/* Same as above */
	sizeof(asn_DEF_cam_ts_EXTERNAL_tags_1)
		/sizeof(asn_DEF_cam_ts_EXTERNAL_tags_1[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
	...
	4,	/* Elements count */
	&asn_SPC_cam_ts_EXTERNAL_specs_1	/* Additional specs */
};
