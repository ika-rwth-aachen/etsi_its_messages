...
static int asn_DFL_5_cmp_12800(const void *sptr) {
	const cam_ts_DeltaAltitude_t *st = sptr;
...
static int asn_DFL_5_set_12800(void **sptr) {
	cam_ts_DeltaAltitude_t *st = *sptr;
...
static int asn_DFL_6_cmp_15(const void *sptr) {
	const cam_ts_AltitudeConfidence_t *st = sptr;
...
static int asn_DFL_6_set_15(void **sptr) {
	cam_ts_AltitudeConfidence_t *st = *sptr;
...
asn_TYPE_member_t asn_MBR_cam_ts_PathPointPredicted_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct cam_ts_PathPointPredicted, deltaLatitude),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct cam_ts_PathPointPredicted, deltaLongitude),
	...
	{ ATF_POINTER, 6, offsetof(struct cam_ts_PathPointPredicted, horizontalPositionConfidence),
	...
	{ ATF_POINTER, 5, offsetof(struct cam_ts_PathPointPredicted, deltaAltitude),
	...
	{ ATF_POINTER, 3, offsetof(struct cam_ts_PathPointPredicted, pathDeltaTime),
	...
	{ ATF_POINTER, 2, offsetof(struct cam_ts_PathPointPredicted, symmetricAreaOffset),
	...
	{ ATF_POINTER, 1, offsetof(struct cam_ts_PathPointPredicted, asymmetricAreaOffset),
...
static const int asn_MAP_cam_ts_PathPointPredicted_oms_1[] = { 2, 3, 4, 5, 6, 7 };
...
asn_SEQUENCE_specifics_t asn_SPC_cam_ts_PathPointPredicted_specs_1 = {
	sizeof(struct cam_ts_PathPointPredicted),
	offsetof(struct cam_ts_PathPointPredicted, _asn_ctx),
	asn_MAP_cam_ts_PathPointPredicted_tag2el_1,
	8,	/* Count of tags in the map */
	asn_MAP_cam_ts_PathPointPredicted_oms_1,	/* Optional members */
	6, 0,	/* Root/Additions */
...
asn_TYPE_descriptor_t asn_DEF_cam_ts_PathPointPredicted = {
	...
	sizeof(asn_DEF_cam_ts_PathPointPredicted_tags_1)
		/sizeof(asn_DEF_cam_ts_PathPointPredicted_tags_1[0]), /* 1 */
	asn_DEF_cam_ts_PathPointPredicted_tags_1,	/* Same as above */
	sizeof(asn_DEF_cam_ts_PathPointPredicted_tags_1)
		/sizeof(asn_DEF_cam_ts_PathPointPredicted_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	8,	/* Elements count */
	&asn_SPC_cam_ts_PathPointPredicted_specs_1	/* Additional specs */
};
