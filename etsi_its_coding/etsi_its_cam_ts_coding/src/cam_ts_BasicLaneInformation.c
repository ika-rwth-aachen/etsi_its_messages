...
asn_TYPE_member_t asn_MBR_cam_ts_BasicLaneInformation_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct cam_ts_BasicLaneInformation, laneNumber),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct cam_ts_BasicLaneInformation, direction),
	...
	{ ATF_POINTER, 3, offsetof(struct cam_ts_BasicLaneInformation, laneWidth),
	...
	{ ATF_POINTER, 2, offsetof(struct cam_ts_BasicLaneInformation, connectingLane),
	...
	{ ATF_POINTER, 1, offsetof(struct cam_ts_BasicLaneInformation, connectingRoadSection),
...
static const int asn_MAP_cam_ts_BasicLaneInformation_oms_1[] = { 2, 3, 4 };
...
asn_SEQUENCE_specifics_t asn_SPC_cam_ts_BasicLaneInformation_specs_1 = {
	sizeof(struct cam_ts_BasicLaneInformation),
	offsetof(struct cam_ts_BasicLaneInformation, _asn_ctx),
	asn_MAP_cam_ts_BasicLaneInformation_tag2el_1,
	5,	/* Count of tags in the map */
	asn_MAP_cam_ts_BasicLaneInformation_oms_1,	/* Optional members */
	3, 0,	/* Root/Additions */
...
asn_TYPE_descriptor_t asn_DEF_cam_ts_BasicLaneInformation = {
	...
	sizeof(asn_DEF_cam_ts_BasicLaneInformation_tags_1)
		/sizeof(asn_DEF_cam_ts_BasicLaneInformation_tags_1[0]), /* 1 */
	asn_DEF_cam_ts_BasicLaneInformation_tags_1,	/* Same as above */
	sizeof(asn_DEF_cam_ts_BasicLaneInformation_tags_1)
		/sizeof(asn_DEF_cam_ts_BasicLaneInformation_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	5,	/* Elements count */
	&asn_SPC_cam_ts_BasicLaneInformation_specs_1	/* Additional specs */
};
