...
#include "etsi_its_cam_ts_coding/cam_ts_PathPredicted2.h"

static int
memb_cam_ts_pathPredicted_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
asn_TYPE_member_t asn_MBR_cam_ts_PathPredicted2_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct cam_ts_PathPredicted2, pathPredicted),
...
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
			&asn_PER_memb_cam_ts_pathPredicted_constr_2,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct cam_ts_PathPredicted2, usageIndication),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct cam_ts_PathPredicted2, confidenceLevel),
...
asn_SEQUENCE_specifics_t asn_SPC_cam_ts_PathPredicted2_specs_1 = {
	sizeof(struct cam_ts_PathPredicted2),
	offsetof(struct cam_ts_PathPredicted2, _asn_ctx),
...
asn_TYPE_descriptor_t asn_DEF_cam_ts_PathPredicted2 = {
	...
	sizeof(asn_DEF_cam_ts_PathPredicted2_tags_1)
		/sizeof(asn_DEF_cam_ts_PathPredicted2_tags_1[0]), /* 1 */
	asn_DEF_cam_ts_PathPredicted2_tags_1,	/* Same as above */
	sizeof(asn_DEF_cam_ts_PathPredicted2_tags_1)
		/sizeof(asn_DEF_cam_ts_PathPredicted2_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	3,	/* Elements count */
	&asn_SPC_cam_ts_PathPredicted2_specs_1	/* Additional specs */
};
