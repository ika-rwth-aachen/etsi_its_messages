...
int
denm_VDS_constraint(const asn_TYPE_descriptor_t *td, const void *sptr,
...
asn_TYPE_descriptor_t asn_DEF_denm_VDS = {
	...
	sizeof(asn_DEF_denm_VDS_tags_1)
		/sizeof(asn_DEF_denm_VDS_tags_1[0]), /* 1 */
	asn_DEF_denm_VDS_tags_1,	/* Same as above */
	sizeof(asn_DEF_denm_VDS_tags_1)
		/sizeof(asn_DEF_denm_VDS_tags_1[0]), /* 1 */
	{
