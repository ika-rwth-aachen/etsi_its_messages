...
static int asn_DFL_9_cmp_600(const void *sptr) {
	const denm_ValidityDuration_t *st = sptr;
...
static int asn_DFL_9_set_600(void **sptr) {
	denm_ValidityDuration_t *st = *sptr;
...
asn_TYPE_member_t asn_MBR_denm_ManagementContainer_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct denm_ManagementContainer, actionID),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct denm_ManagementContainer, detectionTime),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct denm_ManagementContainer, referenceTime),
	...
	{ ATF_POINTER, 1, offsetof(struct denm_ManagementContainer, termination),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct denm_ManagementContainer, eventPosition),
	...
	{ ATF_POINTER, 4, offsetof(struct denm_ManagementContainer, relevanceDistance),
	...
	{ ATF_POINTER, 3, offsetof(struct denm_ManagementContainer, relevanceTrafficDirection),
	...
	{ ATF_POINTER, 2, offsetof(struct denm_ManagementContainer, validityDuration),
	...
	{ ATF_POINTER, 1, offsetof(struct denm_ManagementContainer, transmissionInterval),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct denm_ManagementContainer, stationType),
...
static const int asn_MAP_denm_ManagementContainer_oms_1[] = { 3, 5, 6, 7, 8 };
...
asn_SEQUENCE_specifics_t asn_SPC_denm_ManagementContainer_specs_1 = {
	sizeof(struct denm_ManagementContainer),
	offsetof(struct denm_ManagementContainer, _asn_ctx),
	asn_MAP_denm_ManagementContainer_tag2el_1,
	10,	/* Count of tags in the map */
	asn_MAP_denm_ManagementContainer_oms_1,	/* Optional members */
	5, 0,	/* Root/Additions */
...
asn_TYPE_descriptor_t asn_DEF_denm_ManagementContainer = {
	...
	sizeof(asn_DEF_denm_ManagementContainer_tags_1)
		/sizeof(asn_DEF_denm_ManagementContainer_tags_1[0]), /* 1 */
	asn_DEF_denm_ManagementContainer_tags_1,	/* Same as above */
	sizeof(asn_DEF_denm_ManagementContainer_tags_1)
		/sizeof(asn_DEF_denm_ManagementContainer_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	10,	/* Elements count */
	&asn_SPC_denm_ManagementContainer_specs_1	/* Additional specs */
};
