...
asn_TYPE_member_t asn_MBR_denm_PathPoint_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct denm_PathPoint, pathPosition),
	...
	{ ATF_POINTER, 1, offsetof(struct denm_PathPoint, pathDeltaTime),
...
static const int asn_MAP_denm_PathPoint_oms_1[] = { 1 };
...
asn_SEQUENCE_specifics_t asn_SPC_denm_PathPoint_specs_1 = {
	sizeof(struct denm_PathPoint),
	offsetof(struct denm_PathPoint, _asn_ctx),
	asn_MAP_denm_PathPoint_tag2el_1,
	2,	/* Count of tags in the map */
	asn_MAP_denm_PathPoint_oms_1,	/* Optional members */
	1, 0,	/* Root/Additions */
...
asn_TYPE_descriptor_t asn_DEF_denm_PathPoint = {
	...
	sizeof(asn_DEF_denm_PathPoint_tags_1)
		/sizeof(asn_DEF_denm_PathPoint_tags_1[0]), /* 1 */
	asn_DEF_denm_PathPoint_tags_1,	/* Same as above */
	sizeof(asn_DEF_denm_PathPoint_tags_1)
		/sizeof(asn_DEF_denm_PathPoint_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	2,	/* Elements count */
	&asn_SPC_denm_PathPoint_specs_1	/* Additional specs */
};
