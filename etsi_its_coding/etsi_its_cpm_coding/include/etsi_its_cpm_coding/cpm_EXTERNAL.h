...
#ifndef	_cpm_EXTERNAL_H_
#define	_cpm_EXTERNAL_H_
...
/* Dependencies */
typedef enum cpm_EXTERNAL__encoding_PR {
	cpm_EXTERNAL__encoding_PR_NOTHING,	/* No components present */
	cpm_EXTERNAL__encoding_PR_single_ASN1_type,
	cpm_EXTERNAL__encoding_PR_octet_aligned,
	cpm_EXTERNAL__encoding_PR_arbitrary
} cpm_EXTERNAL__encoding_PR;

/* cpm_EXTERNAL */
typedef struct cpm_EXTERNAL {
	OBJECT_IDENTIFIER_t	*direct_reference;	/* OPTIONAL */
	long	*indirect_reference;	/* OPTIONAL */
	ObjectDescriptor_t	*data_value_descriptor;	/* OPTIONAL */
	struct cpm_EXTERNAL__encoding {
		cpm_EXTERNAL__encoding_PR present;
		union cpm_EXTERNAL__cpm_encoding_u {
...
/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_cpm_EXTERNAL;

#ifdef __cplusplus
}
#endif

#endif	/* _cpm_EXTERNAL_H_ */
