...
#include <etsi_its_cpm_coding/ber_decoder.h>  /* Basic Encoding Rules decoder */
#include <etsi_its_cpm_coding/der_encoder.h>  /* Distinguished Encoding Rules encoder */
#else
...
#include <etsi_its_cpm_coding/xer_decoder.h>  /* Decoder of XER (XML, text) */
#include <etsi_its_cpm_coding/xer_encoder.h>  /* Encoder into XER (XML, text) */
#else
...
#include <etsi_its_cpm_coding/jer_encoder.h>  /* Encoder into JER (JSON, text) */
#else
...
#include <etsi_its_cpm_coding/oer_decoder.h>  /* Octet Encoding Rules encoder */
#include <etsi_its_cpm_coding/oer_encoder.h>  /* Octet Encoding Rules encoder */
#else
