...
#ifndef	_cpm_ItineraryPath_H_
#define	_cpm_ItineraryPath_H_
...
/* cpm_ItineraryPath */
typedef struct cpm_ItineraryPath {
...
/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_cpm_ItineraryPath;
