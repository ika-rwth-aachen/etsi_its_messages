...
#ifndef	_cpm_CenDsrcTollingZone_H_
#define	_cpm_CenDsrcTollingZone_H_
...
/* cpm_CenDsrcTollingZone */
typedef struct cpm_CenDsrcTollingZone {
	cpm_Latitude_t	 protectedZoneLatitude;
	cpm_Longitude_t	 protectedZoneLongitude;
	cpm_ProtectedZoneId_t	*cenDsrcTollingZoneId;	/* OPTIONAL */
	/*
...
} cpm_CenDsrcTollingZone_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_cpm_CenDsrcTollingZone;

#ifdef __cplusplus
}
#endif

#endif	/* _cpm_CenDsrcTollingZone_H_ */
