...
#ifndef	_cpm_ActionIdList_H_
#define	_cpm_ActionIdList_H_
...
/* cpm_ActionIdList */
typedef struct cpm_ActionIdList {
	A_SEQUENCE_OF(struct cpm_ActionId) list;
...
/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_cpm_ActionIdList;
