...
asn_per_constraints_t asn_PER_type_cpm_DangerousGoodsBasic_constr_1 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 5,  5,  0,  19 }	/* (0..19) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
static const asn_INTEGER_enum_map_t asn_MAP_cpm_DangerousGoodsBasic_value2enum_1[] = {
	{ 0,	11,	"explosives1" },
	{ 1,	11,	"explosives2" },
	{ 2,	11,	"explosives3" },
	{ 3,	11,	"explosives4" },
...
static const unsigned int asn_MAP_cpm_DangerousGoodsBasic_enum2value_1[] = {
...
const asn_INTEGER_specifics_t asn_SPC_cpm_DangerousGoodsBasic_specs_1 = {
	asn_MAP_cpm_DangerousGoodsBasic_value2enum_1,	/* "tag" => N; sorted by tag */
	asn_MAP_cpm_DangerousGoodsBasic_enum2value_1,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_cpm_DangerousGoodsBasic_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
asn_TYPE_descriptor_t asn_DEF_cpm_DangerousGoodsBasic = {
	"DangerousGoodsBasic",
	"DangerousGoodsBasic",
	&asn_OP_NativeEnumerated,
	asn_DEF_cpm_DangerousGoodsBasic_tags_1,
	sizeof(asn_DEF_cpm_DangerousGoodsBasic_tags_1)
		/sizeof(asn_DEF_cpm_DangerousGoodsBasic_tags_1[0]), /* 1 */
	asn_DEF_cpm_DangerousGoodsBasic_tags_1,	/* Same as above */
	sizeof(asn_DEF_cpm_DangerousGoodsBasic_tags_1)
		/sizeof(asn_DEF_cpm_DangerousGoodsBasic_tags_1[0]), /* 1 */
	{
...
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_cpm_DangerousGoodsBasic_constr_1,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
	...
	&asn_SPC_cpm_DangerousGoodsBasic_specs_1	/* Additional specs */
};
