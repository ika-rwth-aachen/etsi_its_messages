...
asn_per_constraints_t asn_PER_type_rtcmem_ts_RequestImportanceLevel_constr_1 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 4,  4,  0,  15 }	/* (0..15) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
static const asn_INTEGER_enum_map_t asn_MAP_rtcmem_ts_RequestImportanceLevel_value2enum_1[] = {
...
static const unsigned int asn_MAP_rtcmem_ts_RequestImportanceLevel_enum2value_1[] = {
...
const asn_INTEGER_specifics_t asn_SPC_rtcmem_ts_RequestImportanceLevel_specs_1 = {
	asn_MAP_rtcmem_ts_RequestImportanceLevel_value2enum_1,	/* "tag" => N; sorted by tag */
	asn_MAP_rtcmem_ts_RequestImportanceLevel_enum2value_1,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_rtcmem_ts_RequestImportanceLevel_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
asn_TYPE_descriptor_t asn_DEF_rtcmem_ts_RequestImportanceLevel = {
	"RequestImportanceLevel",
	"RequestImportanceLevel",
	&asn_OP_NativeEnumerated,
	asn_DEF_rtcmem_ts_RequestImportanceLevel_tags_1,
	sizeof(asn_DEF_rtcmem_ts_RequestImportanceLevel_tags_1)
		/sizeof(asn_DEF_rtcmem_ts_RequestImportanceLevel_tags_1[0]), /* 1 */
	asn_DEF_rtcmem_ts_RequestImportanceLevel_tags_1,	/* Same as above */
	sizeof(asn_DEF_rtcmem_ts_RequestImportanceLevel_tags_1)
		/sizeof(asn_DEF_rtcmem_ts_RequestImportanceLevel_tags_1[0]), /* 1 */
	{
...
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_rtcmem_ts_RequestImportanceLevel_constr_1,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
	...
	&asn_SPC_rtcmem_ts_RequestImportanceLevel_specs_1	/* Additional specs */
};
