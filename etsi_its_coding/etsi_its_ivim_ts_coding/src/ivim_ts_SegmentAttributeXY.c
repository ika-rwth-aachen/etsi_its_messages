...
#include "etsi_its_ivim_ts_coding/ivim_ts_SegmentAttributeXY.h"
...
asn_per_constraints_t asn_PER_type_ivim_ts_SegmentAttributeXY_constr_1 CC_NOTUSED = {
	{ APC_CONSTRAINED | APC_EXTENSIBLE,  6,  6,  0,  37 }	/* (0..37,...) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
static const asn_INTEGER_enum_map_t asn_MAP_ivim_ts_SegmentAttributeXY_value2enum_1[] = {
	{ 0,	8,	"reserved" },
	{ 1,	10,	"doNotBlock" },
	{ 2,	9,	"whiteLine" },
...
static const unsigned int asn_MAP_ivim_ts_SegmentAttributeXY_enum2value_1[] = {
...
const asn_INTEGER_specifics_t asn_SPC_ivim_ts_SegmentAttributeXY_specs_1 = {
	asn_MAP_ivim_ts_SegmentAttributeXY_value2enum_1,	/* "tag" => N; sorted by tag */
	asn_MAP_ivim_ts_SegmentAttributeXY_enum2value_1,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_ivim_ts_SegmentAttributeXY_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
asn_TYPE_descriptor_t asn_DEF_ivim_ts_SegmentAttributeXY = {
	"SegmentAttributeXY",
	"SegmentAttributeXY",
	&asn_OP_NativeEnumerated,
	asn_DEF_ivim_ts_SegmentAttributeXY_tags_1,
	sizeof(asn_DEF_ivim_ts_SegmentAttributeXY_tags_1)
		/sizeof(asn_DEF_ivim_ts_SegmentAttributeXY_tags_1[0]), /* 1 */
	asn_DEF_ivim_ts_SegmentAttributeXY_tags_1,	/* Same as above */
	sizeof(asn_DEF_ivim_ts_SegmentAttributeXY_tags_1)
		/sizeof(asn_DEF_ivim_ts_SegmentAttributeXY_tags_1[0]), /* 1 */
	{
...
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_ivim_ts_SegmentAttributeXY_constr_1,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
	...
	&asn_SPC_ivim_ts_SegmentAttributeXY_specs_1	/* Additional specs */
};
