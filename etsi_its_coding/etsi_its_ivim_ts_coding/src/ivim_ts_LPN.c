...
#include "etsi_its_ivim_ts_coding/ivim_ts_LPN.h"
...
static asn_per_constraints_t asn_PER_type_ivim_ts_alphabetIndicator_constr_3 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 6,  6,  0,  32 }	/* (0..32) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
static const asn_INTEGER_enum_map_t asn_MAP_ivim_ts_alphabetIndicator_value2enum_3[] = {
...
static const unsigned int asn_MAP_ivim_ts_alphabetIndicator_enum2value_3[] = {
...
static const asn_INTEGER_specifics_t asn_SPC_ivim_ts_alphabetIndicator_specs_3 = {
	asn_MAP_ivim_ts_alphabetIndicator_value2enum_3,	/* "tag" => N; sorted by tag */
	asn_MAP_ivim_ts_alphabetIndicator_enum2value_3,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_ivim_ts_alphabetIndicator_tags_3[] = {
	(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_ivim_ts_alphabetIndicator_3 = {
	"alphabetIndicator",
	"alphabetIndicator",
	&asn_OP_NativeEnumerated,
	asn_DEF_ivim_ts_alphabetIndicator_tags_3,
	sizeof(asn_DEF_ivim_ts_alphabetIndicator_tags_3)
		/sizeof(asn_DEF_ivim_ts_alphabetIndicator_tags_3[0]) - 1, /* 1 */
	asn_DEF_ivim_ts_alphabetIndicator_tags_3,	/* Same as above */
	sizeof(asn_DEF_ivim_ts_alphabetIndicator_tags_3)
		/sizeof(asn_DEF_ivim_ts_alphabetIndicator_tags_3[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_ivim_ts_alphabetIndicator_constr_3,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
	...
	&asn_SPC_ivim_ts_alphabetIndicator_specs_3	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_ivim_ts_LPN_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct ivim_ts_LPN, countryCode),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ivim_ts_CountryCode,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ivim_ts_LPN, alphabetIndicator),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ivim_ts_alphabetIndicator_3,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ivim_ts_LPN, licencePlateNumber),
...
static const ber_tlv_tag_t asn_DEF_ivim_ts_LPN_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_ivim_ts_LPN_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_ivim_ts_LPN_specs_1 = {
	sizeof(struct ivim_ts_LPN),
	offsetof(struct ivim_ts_LPN, _asn_ctx),
	asn_MAP_ivim_ts_LPN_tag2el_1,
	3,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_ivim_ts_LPN = {
	"LPN",
	"LPN",
	&asn_OP_SEQUENCE,
	asn_DEF_ivim_ts_LPN_tags_1,
	sizeof(asn_DEF_ivim_ts_LPN_tags_1)
		/sizeof(asn_DEF_ivim_ts_LPN_tags_1[0]), /* 1 */
	asn_DEF_ivim_ts_LPN_tags_1,	/* Same as above */
	sizeof(asn_DEF_ivim_ts_LPN_tags_1)
		/sizeof(asn_DEF_ivim_ts_LPN_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
