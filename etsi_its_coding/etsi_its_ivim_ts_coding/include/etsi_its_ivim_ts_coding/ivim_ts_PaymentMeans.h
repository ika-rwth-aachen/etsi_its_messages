...
#ifndef	_ivim_ts_PaymentMeans_H_
#define	_ivim_ts_PaymentMeans_H_
...
/* ivim_ts_PaymentMeans */
typedef struct ivim_ts_PaymentMeans {
	ivim_ts_PersonalAccountNumber_t	 personalAccountNumber;
	ivim_ts_DateCompact_t	 paymentMeansExpiryDate;
	OCTET_STRING_t	 pamentMeansUsageControl;
	
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} ivim_ts_PaymentMeans_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_ivim_ts_PaymentMeans;

#ifdef __cplusplus
}
#endif

#endif	/* _ivim_ts_PaymentMeans_H_ */
