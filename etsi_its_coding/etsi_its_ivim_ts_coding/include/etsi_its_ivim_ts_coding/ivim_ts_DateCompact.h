...
#ifndef	_ivim_ts_DateCompact_H_
#define	_ivim_ts_DateCompact_H_
...
/* ivim_ts_DateCompact */
typedef struct ivim_ts_DateCompact {
	long	 year;
	long	 month;
	long	 day;
...
} ivim_ts_DateCompact_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_ivim_ts_DateCompact;
extern asn_SEQUENCE_specifics_t asn_SPC_ivim_ts_DateCompact_specs_1;
extern asn_TYPE_member_t asn_MBR_ivim_ts_DateCompact_1[3];

#ifdef __cplusplus
}
#endif

#endif	/* _ivim_ts_DateCompact_H_ */
