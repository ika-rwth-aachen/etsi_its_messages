...
#ifndef	_ivim_ts_ContractValidity_H_
#define	_ivim_ts_ContractValidity_H_
...
/* ivim_ts_ContractValidity */
typedef struct ivim_ts_ContractValidity {
	OCTET_STRING_t	 contractRestrictions;
	ivim_ts_DateCompact_t	 contractExpiryDate;
	
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} ivim_ts_ContractValidity_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_ivim_ts_ContractValidity;

#ifdef __cplusplus
}
#endif

#endif	/* _ivim_ts_ContractValidity_H_ */
