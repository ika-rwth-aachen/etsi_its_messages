...
#ifndef	_ivim_ts_SessionClass_H_
#define	_ivim_ts_SessionClass_H_
...
/* ivim_ts_SessionClass */
typedef struct ivim_ts_SessionClass {
	ivim_ts_Int1_t	 sessionTariffClass;
	ivim_ts_Int1_t	 sessionClaimedClass;
	
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} ivim_ts_SessionClass_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_ivim_ts_SessionClass;

#ifdef __cplusplus
}
#endif

#endif	/* _ivim_ts_SessionClass_H_ */
