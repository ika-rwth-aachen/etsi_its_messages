...
#ifndef	_ivim_ts_SignalControlZone_H_
#define	_ivim_ts_SignalControlZone_H_
...
/* ivim_ts_SignalControlZone */
typedef struct ivim_ts_SignalControlZone {
	ivim_ts_Reg_SignalControlZone_t	 zone;
	/*
...
} ivim_ts_SignalControlZone_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_ivim_ts_SignalControlZone;
extern asn_SEQUENCE_specifics_t asn_SPC_ivim_ts_SignalControlZone_specs_1;
extern asn_TYPE_member_t asn_MBR_ivim_ts_SignalControlZone_1[1];

#ifdef __cplusplus
}
#endif

#endif	/* _ivim_ts_SignalControlZone_H_ */
