...
#ifndef	_ivim_ts_SoundLevel_H_
#define	_ivim_ts_SoundLevel_H_
...
/* ivim_ts_SoundLevel */
typedef struct ivim_ts_SoundLevel {
	ivim_ts_Int1_t	 soundstationary;
	ivim_ts_Int1_t	 sounddriveby;
	
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} ivim_ts_SoundLevel_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_ivim_ts_SoundLevel;
extern asn_SEQUENCE_specifics_t asn_SPC_ivim_ts_SoundLevel_specs_1;
extern asn_TYPE_member_t asn_MBR_ivim_ts_SoundLevel_1[2];

#ifdef __cplusplus
}
#endif

#endif	/* _ivim_ts_SoundLevel_H_ */
