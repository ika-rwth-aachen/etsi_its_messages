...
#ifndef	_ivim_ts_VehicleDimensions_H_
#define	_ivim_ts_VehicleDimensions_H_
...
/* ivim_ts_VehicleDimensions */
typedef struct ivim_ts_VehicleDimensions {
	ivim_ts_Int1_t	 vehicleLengthOverall;
	ivim_ts_Int1_t	 vehicleHeigthOverall;
	ivim_ts_Int1_t	 vehicleWidthOverall;
	
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} ivim_ts_VehicleDimensions_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_ivim_ts_VehicleDimensions;
extern asn_SEQUENCE_specifics_t asn_SPC_ivim_ts_VehicleDimensions_specs_1;
extern asn_TYPE_member_t asn_MBR_ivim_ts_VehicleDimensions_1[3];

#ifdef __cplusplus
}
#endif

#endif	/* _ivim_ts_VehicleDimensions_H_ */
