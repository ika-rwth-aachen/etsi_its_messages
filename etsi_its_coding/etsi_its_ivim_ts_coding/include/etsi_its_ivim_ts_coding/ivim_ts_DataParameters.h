...
#ifndef	_ivim_ts_DataParameters_H_
#define	_ivim_ts_DataParameters_H_
...
/* ivim_ts_DataParameters */
typedef struct ivim_ts_DataParameters {
...
} ivim_ts_DataParameters_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_ivim_ts_DataParameters;
extern asn_SEQUENCE_specifics_t asn_SPC_ivim_ts_DataParameters_specs_1;
extern asn_TYPE_member_t asn_MBR_ivim_ts_DataParameters_1[4];

#ifdef __cplusplus
}
#endif

#endif	/* _ivim_ts_DataParameters_H_ */
