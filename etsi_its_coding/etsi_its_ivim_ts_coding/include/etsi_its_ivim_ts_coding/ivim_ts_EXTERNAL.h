...
#ifndef	_ivim_ts_EXTERNAL_H_
#define	_ivim_ts_EXTERNAL_H_
...
/* Dependencies */
typedef enum ivim_ts_EXTERNAL__encoding_PR {
	ivim_ts_EXTERNAL__encoding_PR_NOTHING,	/* No components present */
	ivim_ts_EXTERNAL__encoding_PR_single_ASN1_type,
	ivim_ts_EXTERNAL__encoding_PR_octet_aligned,
	ivim_ts_EXTERNAL__encoding_PR_arbitrary
} ivim_ts_EXTERNAL__encoding_PR;

/* ivim_ts_EXTERNAL */
typedef struct ivim_ts_EXTERNAL {
	OBJECT_IDENTIFIER_t	*direct_reference;	/* OPTIONAL */
	long	*indirect_reference;	/* OPTIONAL */
	ObjectDescriptor_t	*data_value_descriptor;	/* OPTIONAL */
	struct ivim_ts_EXTERNAL__encoding {
		ivim_ts_EXTERNAL__encoding_PR present;
		union ivim_ts_EXTERNAL__ivim_ts_encoding_u {
...
/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_ivim_ts_EXTERNAL;

#ifdef __cplusplus
}
#endif

#endif	/* _ivim_ts_EXTERNAL_H_ */
