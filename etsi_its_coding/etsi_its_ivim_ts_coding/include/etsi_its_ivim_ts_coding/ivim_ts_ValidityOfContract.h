...
#ifndef	_ivim_ts_ValidityOfContract_H_
#define	_ivim_ts_ValidityOfContract_H_
...
/* ivim_ts_ValidityOfContract */
typedef struct ivim_ts_ValidityOfContract {
	OCTET_STRING_t	 issuerRestrictions;
	ivim_ts_DateCompact_t	 contractExpiryDate;
	
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} ivim_ts_ValidityOfContract_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_ivim_ts_ValidityOfContract;

#ifdef __cplusplus
}
#endif

#endif	/* _ivim_ts_ValidityOfContract_H_ */
