...
#ifndef	_ivim_ts_IntersectionGeometry_H_
#define	_ivim_ts_IntersectionGeometry_H_
...
#include "etsi_its_ivim_ts_coding/ivim_ts_LaneList.h"
...
struct ivim_ts_PreemptPriorityList;
struct ivim_ts_Reg_IntersectionGeometry;

/* ivim_ts_IntersectionGeometry */
typedef struct ivim_ts_IntersectionGeometry {
	...
	ivim_ts_LaneList_t	 laneSet;
	struct ivim_ts_PreemptPriorityList	*preemptPriorityData;	/* OPTIONAL */
	struct ivim_ts_IntersectionGeometry__regional {
		A_SEQUENCE_OF(struct ivim_ts_Reg_IntersectionGeometry) list;
	...
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} ivim_ts_IntersectionGeometry_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_ivim_ts_IntersectionGeometry;
extern asn_SEQUENCE_specifics_t asn_SPC_ivim_ts_IntersectionGeometry_specs_1;
extern asn_TYPE_member_t asn_MBR_ivim_ts_IntersectionGeometry_1[9];
...
#endif	/* _ivim_ts_IntersectionGeometry_H_ */
