...
#ifndef	_ivim_ts_Traces_H_
#define	_ivim_ts_Traces_H_
...
struct ivim_ts_PathHistory;

/* ivim_ts_Traces */
typedef struct ivim_ts_Traces {
	A_SEQUENCE_OF(struct ivim_ts_PathHistory) list;
...
/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_ivim_ts_Traces;
