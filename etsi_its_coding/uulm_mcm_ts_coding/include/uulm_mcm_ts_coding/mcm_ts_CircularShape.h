...
#ifndef	_mcm_ts_CircularShape_H_
#define	_mcm_ts_CircularShape_H_
...
/* mcm_ts_CircularShape */
typedef struct mcm_ts_CircularShape {
	struct mcm_ts_CartesianPosition3d	*shapeReferencePoint;	/* OPTIONAL */
	mcm_ts_StandardLength12b_t	 radius;
	mcm_ts_StandardLength12b_t	*height;	/* OPTIONAL */
	
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} mcm_ts_CircularShape_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_mcm_ts_CircularShape;
extern asn_SEQUENCE_specifics_t asn_SPC_mcm_ts_CircularShape_specs_1;
extern asn_TYPE_member_t asn_MBR_mcm_ts_CircularShape_1[3];
...
#endif	/* _mcm_ts_CircularShape_H_ */
