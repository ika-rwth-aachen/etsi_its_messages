...
#ifndef	_denm_ts_DigitalMap_H_
#define	_denm_ts_DigitalMap_H_
...
/* denm_ts_DigitalMap */
typedef struct denm_ts_DigitalMap {
	A_SEQUENCE_OF(struct denm_ts_ReferencePosition) list;
	
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} denm_ts_DigitalMap_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_denm_ts_DigitalMap;
