...
#ifndef	_spatem_ts_EXTERNAL_H_
#define	_spatem_ts_EXTERNAL_H_
...
/* Dependencies */
typedef enum spatem_ts_EXTERNAL__encoding_PR {
	spatem_ts_EXTERNAL__encoding_PR_NOTHING,	/* No components present */
	spatem_ts_EXTERNAL__encoding_PR_single_ASN1_type,
	spatem_ts_EXTERNAL__encoding_PR_octet_aligned,
	spatem_ts_EXTERNAL__encoding_PR_arbitrary
} spatem_ts_EXTERNAL__encoding_PR;

/* spatem_ts_EXTERNAL */
typedef struct spatem_ts_EXTERNAL {
	OBJECT_IDENTIFIER_t	*direct_reference;	/* OPTIONAL */
	long	*indirect_reference;	/* OPTIONAL */
	ObjectDescriptor_t	*data_value_descriptor;	/* OPTIONAL */
	struct spatem_ts_EXTERNAL__encoding {
		spatem_ts_EXTERNAL__encoding_PR present;
		union spatem_ts_EXTERNAL__spatem_ts_encoding_u {
	...
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} spatem_ts_EXTERNAL_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_spatem_ts_EXTERNAL;

#ifdef __cplusplus
}
#endif

#endif	/* _spatem_ts_EXTERNAL_H_ */
