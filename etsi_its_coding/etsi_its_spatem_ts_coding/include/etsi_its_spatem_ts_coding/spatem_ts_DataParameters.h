...
#ifndef	_spatem_ts_DataParameters_H_
#define	_spatem_ts_DataParameters_H_
...
typedef struct spatem_ts_DataParameters {
...
} spatem_ts_DataParameters_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_spatem_ts_DataParameters;
extern asn_SEQUENCE_specifics_t asn_SPC_spatem_ts_DataParameters_specs_1;
extern asn_TYPE_member_t asn_MBR_spatem_ts_DataParameters_1[4];

#ifdef __cplusplus
}
#endif

#endif	/* _spatem_ts_DataParameters_H_ */
