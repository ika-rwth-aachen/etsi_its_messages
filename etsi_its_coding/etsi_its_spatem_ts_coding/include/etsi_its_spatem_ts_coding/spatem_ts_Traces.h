...
#ifndef	_spatem_ts_Traces_H_
#define	_spatem_ts_Traces_H_
...
struct spatem_ts_PathHistory;

/* spatem_ts_Traces */
typedef struct spatem_ts_Traces {
	A_SEQUENCE_OF(struct spatem_ts_PathHistory) list;
...
/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_spatem_ts_Traces;
