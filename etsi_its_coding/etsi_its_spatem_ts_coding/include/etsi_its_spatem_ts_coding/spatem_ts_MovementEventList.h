...
#ifndef	_spatem_ts_MovementEventList_H_
#define	_spatem_ts_MovementEventList_H_
...
typedef struct spatem_ts_MovementEventList {
	A_SEQUENCE_OF(struct spatem_ts_MovementEvent) list;
	
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} spatem_ts_MovementEventList_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_spatem_ts_MovementEventList;
extern asn_SET_OF_specifics_t asn_SPC_spatem_ts_MovementEventList_specs_1;
extern asn_TYPE_member_t asn_MBR_spatem_ts_MovementEventList_1[1];
extern asn_per_constraints_t asn_PER_type_spatem_ts_MovementEventList_constr_1;
...
#endif	/* _spatem_ts_MovementEventList_H_ */
