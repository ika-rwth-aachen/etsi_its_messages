...
#ifndef	_spatem_ts_SignalStatusMessage_H_
#define	_spatem_ts_SignalStatusMessage_H_
...
/* spatem_ts_SignalStatusMessage */
typedef struct spatem_ts_SignalStatusMessage {
	spatem_ts_MinuteOfTheYear_t	*timeStamp;	/* OPTIONAL */
	spatem_ts_DSecond_t	 second;
	spatem_ts_MsgCount_t	*sequenceNumber;	/* OPTIONAL */
	spatem_ts_SignalStatusList_t	 status;
	struct spatem_ts_SignalStatusMessage__regional {
		A_SEQUENCE_OF(struct spatem_ts_Reg_SignalStatusMessage) list;
	...
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} spatem_ts_SignalStatusMessage_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_spatem_ts_SignalStatusMessage;
...
#endif	/* _spatem_ts_SignalStatusMessage_H_ */
