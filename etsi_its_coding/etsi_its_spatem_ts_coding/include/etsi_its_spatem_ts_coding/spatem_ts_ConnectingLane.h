...
#ifndef	_spatem_ts_ConnectingLane_H_
#define	_spatem_ts_ConnectingLane_H_
...
/* spatem_ts_ConnectingLane */
typedef struct spatem_ts_ConnectingLane {
	spatem_ts_LaneID_t	 lane;
	spatem_ts_AllowedManeuvers_t	*maneuver;	/* OPTIONAL */
	
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} spatem_ts_ConnectingLane_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_spatem_ts_ConnectingLane;
extern asn_SEQUENCE_specifics_t asn_SPC_spatem_ts_ConnectingLane_specs_1;
extern asn_TYPE_member_t asn_MBR_spatem_ts_ConnectingLane_1[2];

#ifdef __cplusplus
}
#endif

#endif	/* _spatem_ts_ConnectingLane_H_ */
