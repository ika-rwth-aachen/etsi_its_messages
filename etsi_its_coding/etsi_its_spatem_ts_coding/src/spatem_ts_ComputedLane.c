...
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_spatem_ts_offsetYaxis_constr_6 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_spatem_ts_regional_constr_12 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_memb_spatem_ts_regional_constr_12 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 2,  2,  1,  4 }	/* (SIZE(1..4)) */,
	0, 0	/* No PER value map */
};
...
static asn_TYPE_member_t asn_MBR_spatem_ts_offsetXaxis_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct spatem_ts_ComputedLane__offsetXaxis, choice.small),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct spatem_ts_ComputedLane__offsetXaxis, choice.large),
...
asn_TYPE_descriptor_t asn_DEF_spatem_ts_offsetXaxis_3 = {
	...
	2,	/* Elements count */
	&asn_SPC_spatem_ts_offsetXaxis_specs_3	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_spatem_ts_offsetYaxis_6[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct spatem_ts_ComputedLane__offsetYaxis, choice.small),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_spatem_ts_DrivenLineOffsetSm,
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct spatem_ts_ComputedLane__offsetYaxis, choice.large),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_spatem_ts_DrivenLineOffsetLg,
		0,
...
asn_TYPE_descriptor_t asn_DEF_spatem_ts_offsetYaxis_6 = {
	...
	2,	/* Elements count */
	&asn_SPC_spatem_ts_offsetYaxis_specs_6	/* Additional specs */
};
...
asn_TYPE_descriptor_t asn_DEF_spatem_ts_regional_12 = {
	...
	sizeof(asn_DEF_spatem_ts_regional_tags_12)
		/sizeof(asn_DEF_spatem_ts_regional_tags_12[0]) - 1, /* 1 */
	asn_DEF_spatem_ts_regional_tags_12,	/* Same as above */
	sizeof(asn_DEF_spatem_ts_regional_tags_12)
		/sizeof(asn_DEF_spatem_ts_regional_tags_12[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_spatem_ts_regional_constr_12,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
	...
	1,	/* Single element */
	&asn_SPC_spatem_ts_regional_specs_12	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_spatem_ts_ComputedLane_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct spatem_ts_ComputedLane, referenceLaneId),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct spatem_ts_ComputedLane, offsetXaxis),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct spatem_ts_ComputedLane, offsetYaxis),
	...
	{ ATF_POINTER, 4, offsetof(struct spatem_ts_ComputedLane, rotateXY),
	...
	{ ATF_POINTER, 3, offsetof(struct spatem_ts_ComputedLane, scaleXaxis),
	...
	{ ATF_POINTER, 2, offsetof(struct spatem_ts_ComputedLane, scaleYaxis),
	...
	{ ATF_POINTER, 1, offsetof(struct spatem_ts_ComputedLane, regional),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		0,
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
			&asn_PER_memb_spatem_ts_regional_constr_12,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
			0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
...
asn_SEQUENCE_specifics_t asn_SPC_spatem_ts_ComputedLane_specs_1 = {
	sizeof(struct spatem_ts_ComputedLane),
	offsetof(struct spatem_ts_ComputedLane, _asn_ctx),
	asn_MAP_spatem_ts_ComputedLane_tag2el_1,
	7,	/* Count of tags in the map */
	asn_MAP_spatem_ts_ComputedLane_oms_1,	/* Optional members */
	4, 0,	/* Root/Additions */
...
asn_TYPE_descriptor_t asn_DEF_spatem_ts_ComputedLane = {
	...
	sizeof(asn_DEF_spatem_ts_ComputedLane_tags_1)
		/sizeof(asn_DEF_spatem_ts_ComputedLane_tags_1[0]), /* 1 */
	asn_DEF_spatem_ts_ComputedLane_tags_1,	/* Same as above */
	sizeof(asn_DEF_spatem_ts_ComputedLane_tags_1)
		/sizeof(asn_DEF_spatem_ts_ComputedLane_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	7,	/* Elements count */
	&asn_SPC_spatem_ts_ComputedLane_specs_1	/* Additional specs */
};
