...
static asn_SET_OF_specifics_t asn_SPC_spatem_ts_regional_specs_5 = {
	sizeof(struct spatem_ts_SignalStatus__regional),
	offsetof(struct spatem_ts_SignalStatus__regional, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_spatem_ts_SignalStatus_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct spatem_ts_SignalStatus, sequenceNumber),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct spatem_ts_SignalStatus, id),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct spatem_ts_SignalStatus, sigStatus),
	...
	{ ATF_POINTER, 1, offsetof(struct spatem_ts_SignalStatus, regional),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
...
static const int asn_MAP_spatem_ts_SignalStatus_oms_1[] = { 3 };
static const ber_tlv_tag_t asn_DEF_spatem_ts_SignalStatus_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_spatem_ts_SignalStatus_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_spatem_ts_SignalStatus_specs_1 = {
	sizeof(struct spatem_ts_SignalStatus),
	offsetof(struct spatem_ts_SignalStatus, _asn_ctx),
	asn_MAP_spatem_ts_SignalStatus_tag2el_1,
	4,	/* Count of tags in the map */
	asn_MAP_spatem_ts_SignalStatus_oms_1,	/* Optional members */
	1, 0,	/* Root/Additions */
	4,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_spatem_ts_SignalStatus = {
	"SignalStatus",
	"SignalStatus",
	&asn_OP_SEQUENCE,
	asn_DEF_spatem_ts_SignalStatus_tags_1,
	sizeof(asn_DEF_spatem_ts_SignalStatus_tags_1)
		/sizeof(asn_DEF_spatem_ts_SignalStatus_tags_1[0]), /* 1 */
	asn_DEF_spatem_ts_SignalStatus_tags_1,	/* Same as above */
	sizeof(asn_DEF_spatem_ts_SignalStatus_tags_1)
		/sizeof(asn_DEF_spatem_ts_SignalStatus_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	4,	/* Elements count */
	&asn_SPC_spatem_ts_SignalStatus_specs_1	/* Additional specs */
};
