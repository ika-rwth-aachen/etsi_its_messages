 ...
 */
static const ber_tlv_tag_t asn_DEF_spatem_ts_TaxCode_tags_1[] = {
...
asn_TYPE_descriptor_t asn_DEF_spatem_ts_TaxCode = {
	...
	"TaxCode",
	&asn_OP_OCTET_STRING,
	asn_DEF_spatem_ts_TaxCode_tags_1,
	sizeof(asn_DEF_spatem_ts_TaxCode_tags_1)
		/sizeof(asn_DEF_spatem_ts_TaxCode_tags_1[0]), /* 1 */
	asn_DEF_spatem_ts_TaxCode_tags_1,	/* Same as above */
	sizeof(asn_DEF_spatem_ts_TaxCode_tags_1)
		/sizeof(asn_DEF_spatem_ts_TaxCode_tags_1[0]), /* 1 */
	{
