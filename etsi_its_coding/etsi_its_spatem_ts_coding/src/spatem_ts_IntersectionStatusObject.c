...
static asn_jer_constraints_t asn_JER_type_spatem_ts_IntersectionStatusObject_constr_1 CC_NOTUSED = {
	16};
...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		&asn_JER_type_spatem_ts_IntersectionStatusObject_constr_1,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
