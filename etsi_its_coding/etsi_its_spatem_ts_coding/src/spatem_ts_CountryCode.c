...
int
spatem_ts_CountryCode_constraint(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_jer_constraints_t asn_JER_type_spatem_ts_CountryCode_constr_1 CC_NOTUSED = {
	10};
...
asn_TYPE_descriptor_t asn_DEF_spatem_ts_CountryCode = {
	...
	sizeof(asn_DEF_spatem_ts_CountryCode_tags_1)
		/sizeof(asn_DEF_spatem_ts_CountryCode_tags_1[0]), /* 1 */
	asn_DEF_spatem_ts_CountryCode_tags_1,	/* Same as above */
	sizeof(asn_DEF_spatem_ts_CountryCode_tags_1)
		/sizeof(asn_DEF_spatem_ts_CountryCode_tags_1[0]), /* 1 */
	{
