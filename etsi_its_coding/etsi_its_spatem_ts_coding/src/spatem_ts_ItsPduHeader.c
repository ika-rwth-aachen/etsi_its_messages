...
static int
memb_spatem_ts_protocolVersion_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static int
memb_spatem_ts_messageID_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_memb_spatem_ts_messageID_constr_3 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 8,  8,  0,  255 }	/* (0..255) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
asn_TYPE_member_t asn_MBR_spatem_ts_ItsPduHeader_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct spatem_ts_ItsPduHeader, protocolVersion),
...
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
			&asn_PER_memb_spatem_ts_protocolVersion_constr_2,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct spatem_ts_ItsPduHeader, messageID),
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
			&asn_PER_memb_spatem_ts_messageID_constr_3,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
			0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct spatem_ts_ItsPduHeader, stationID),
...
asn_SEQUENCE_specifics_t asn_SPC_spatem_ts_ItsPduHeader_specs_1 = {
	sizeof(struct spatem_ts_ItsPduHeader),
	offsetof(struct spatem_ts_ItsPduHeader, _asn_ctx),
...
asn_TYPE_descriptor_t asn_DEF_spatem_ts_ItsPduHeader = {
	...
	sizeof(asn_DEF_spatem_ts_ItsPduHeader_tags_1)
		/sizeof(asn_DEF_spatem_ts_ItsPduHeader_tags_1[0]), /* 1 */
	asn_DEF_spatem_ts_ItsPduHeader_tags_1,	/* Same as above */
	sizeof(asn_DEF_spatem_ts_ItsPduHeader_tags_1)
		/sizeof(asn_DEF_spatem_ts_ItsPduHeader_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	3,	/* Elements count */
	&asn_SPC_spatem_ts_ItsPduHeader_specs_1	/* Additional specs */
};
