...
static asn_SET_OF_specifics_t asn_SPC_spatem_ts_regional_specs_5 = {
	sizeof(struct spatem_ts_MovementEvent__regional),
	offsetof(struct spatem_ts_MovementEvent__regional, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_spatem_ts_MovementEvent_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct spatem_ts_MovementEvent, eventState),
	...
	{ ATF_POINTER, 3, offsetof(struct spatem_ts_MovementEvent, timing),
	...
	{ ATF_POINTER, 2, offsetof(struct spatem_ts_MovementEvent, speeds),
	...
	{ ATF_POINTER, 1, offsetof(struct spatem_ts_MovementEvent, regional),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
...
static const int asn_MAP_spatem_ts_MovementEvent_oms_1[] = { 1, 2, 3 };
...
asn_SEQUENCE_specifics_t asn_SPC_spatem_ts_MovementEvent_specs_1 = {
	...
	offsetof(struct spatem_ts_MovementEvent, _asn_ctx),
	asn_MAP_spatem_ts_MovementEvent_tag2el_1,
	4,	/* Count of tags in the map */
	asn_MAP_spatem_ts_MovementEvent_oms_1,	/* Optional members */
	3, 0,	/* Root/Additions */
...
asn_TYPE_descriptor_t asn_DEF_spatem_ts_MovementEvent = {
	...
	sizeof(asn_DEF_spatem_ts_MovementEvent_tags_1)
		/sizeof(asn_DEF_spatem_ts_MovementEvent_tags_1[0]), /* 1 */
	asn_DEF_spatem_ts_MovementEvent_tags_1,	/* Same as above */
	sizeof(asn_DEF_spatem_ts_MovementEvent_tags_1)
		/sizeof(asn_DEF_spatem_ts_MovementEvent_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	4,	/* Elements count */
	&asn_SPC_spatem_ts_MovementEvent_specs_1	/* Additional specs */
};
