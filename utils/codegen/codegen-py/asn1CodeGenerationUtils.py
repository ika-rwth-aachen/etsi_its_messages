...
def validCTypeAsGenByAsn1c(s: str) -> str:
    """Converts an ASN.1 type name to the C type spelling generated by asn1c.

    Args:
        s (str): e.g., "RTCM-Revision"

    Returns:
        str: e.g., "RTCM_Revision"
    """
...
def asn1TypeToJinjaContext(asn1_type_name: str, asn1_type_info: Dict, asn1_types: Dict[str, Dict], asn1_values: Dict[str, Dict], asn1_sets: Dict[str, Dict], asn1_classes: Dict[str, Dict], inline_constraints: bool = False) -> Dict:
    ...
    context = {
        ...
        "c_type_name": validCTypeAsGenByAsn1c(asn1_type_name),          # CamParameters / RTCM_Revision
