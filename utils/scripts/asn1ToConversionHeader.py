...
def loadJinjaTemplates() -> jinja2.environment.Template:
...
def asn1TypeToConversionHeader(type_name: str, asn1_type: Dict, asn1_types: Dict[str, Dict], asn1_raw: Dict[str, str], etsi_type: str, jinja_templates: jinja2.environment.Template) -> str:
...
def main():
    ...
    for type_name, asn1_type in asn1_types.items():
        ...
        header = asn1TypeToConversionHeader(type_name, asn1_type, asn1_types, asn1_raw, args.type, jinja_templates)
