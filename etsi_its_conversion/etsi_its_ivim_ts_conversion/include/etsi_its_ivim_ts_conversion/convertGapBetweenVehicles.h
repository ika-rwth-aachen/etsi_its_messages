...
#include <etsi_its_ivim_ts_msgs/msg/gap_between_vehicles.hpp>
namespace ivim_ts_msgs = etsi_its_ivim_ts_msgs::msg;


namespace etsi_its_ivim_ts_conversion {

void toRos_GapBetweenVehicles(const ivim_ts_GapBetweenVehicles_t& in, ivim_ts_msgs::GapBetweenVehicles& out) {
  etsi_its_primitives_conversion::toRos_INTEGER(in, out.value);
}

void toStruct_GapBetweenVehicles(const ivim_ts_msgs::GapBetweenVehicles& in, ivim_ts_GapBetweenVehicles_t& out) {
  memset(&out, 0, sizeof(ivim_ts_GapBetweenVehicles_t));
