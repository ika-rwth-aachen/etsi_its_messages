...
#include <etsi_its_ivim_ts_msgs/msg/engine_characteristics.hpp>
namespace ivim_ts_msgs = etsi_its_ivim_ts_msgs::msg;


namespace etsi_its_ivim_ts_conversion {

void toRos_EngineCharacteristics(const ivim_ts_EngineCharacteristics_t& in, ivim_ts_msgs::EngineCharacteristics& out) {
  etsi_its_primitives_conversion::toRos_INTEGER(in, out.value);
}

void toStruct_EngineCharacteristics(const ivim_ts_msgs::EngineCharacteristics& in, ivim_ts_EngineCharacteristics_t& out) {
  memset(&out, 0, sizeof(ivim_ts_EngineCharacteristics_t));
