...
#include <etsi_its_ivim_ts_msgs/msg/definition_accuracy.hpp>
namespace ivim_ts_msgs = etsi_its_ivim_ts_msgs::msg;


namespace etsi_its_ivim_ts_conversion {

void toRos_DefinitionAccuracy(const ivim_ts_DefinitionAccuracy_t& in, ivim_ts_msgs::DefinitionAccuracy& out) {
  etsi_its_primitives_conversion::toRos_INTEGER(in, out.value);
}

void toStruct_DefinitionAccuracy(const ivim_ts_msgs::DefinitionAccuracy& in, ivim_ts_DefinitionAccuracy_t& out) {
  memset(&out, 0, sizeof(ivim_ts_DefinitionAccuracy_t));
