...
#include <etsi_its_ivim_ts_conversion/convertSaeAutomationLevel.h>
#include <etsi_its_ivim_ts_msgs/msg/sae_automation_level.hpp>
#include <etsi_its_ivim_ts_msgs/msg/sae_automation_levels.hpp>
namespace ivim_ts_msgs = etsi_its_ivim_ts_msgs::msg;


namespace etsi_its_ivim_ts_conversion {

void toRos_SaeAutomationLevels(const ivim_ts_SaeAutomationLevels_t& in, ivim_ts_msgs::SaeAutomationLevels& out) {
  for (int i = 0; i < in.list.count; ++i) {
    ivim_ts_msgs::SaeAutomationLevel el;
    toRos_SaeAutomationLevel(*(in.list.array[i]), el);
    out.array.push_back(el);
  }
}

void toStruct_SaeAutomationLevels(const ivim_ts_msgs::SaeAutomationLevels& in, ivim_ts_SaeAutomationLevels_t& out) {
  memset(&out, 0, sizeof(ivim_ts_SaeAutomationLevels_t));
  for (int i = 0; i < in.array.size(); ++i) {
    ivim_ts_SaeAutomationLevel_t* el = (ivim_ts_SaeAutomationLevel_t*) calloc(1, sizeof(ivim_ts_SaeAutomationLevel_t));
    toStruct_SaeAutomationLevel(in.array[i], *el);
