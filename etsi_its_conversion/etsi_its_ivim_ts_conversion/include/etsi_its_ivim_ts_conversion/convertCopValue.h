...
#include <etsi_its_ivim_ts_msgs/msg/cop_value.hpp>
namespace ivim_ts_msgs = etsi_its_ivim_ts_msgs::msg;


namespace etsi_its_ivim_ts_conversion {

void toRos_CopValue(const ivim_ts_CopValue_t& in, ivim_ts_msgs::CopValue& out) {
  out.value = in;
}

void toStruct_CopValue(const ivim_ts_msgs::CopValue& in, ivim_ts_CopValue_t& out) {
  memset(&out, 0, sizeof(ivim_ts_CopValue_t));
  out = in.value;
}
