...
#include <etsi_its_ivim_ts_msgs/msg/int2.hpp>
namespace ivim_ts_msgs = etsi_its_ivim_ts_msgs::msg;


namespace etsi_its_ivim_ts_conversion {

void toRos_Int2(const ivim_ts_Int2_t& in, ivim_ts_msgs::Int2& out) {
  etsi_its_primitives_conversion::toRos_INTEGER(in, out.value);
}

void toStruct_Int2(const ivim_ts_msgs::Int2& in, ivim_ts_Int2_t& out) {
  memset(&out, 0, sizeof(ivim_ts_Int2_t));
