...
#include <etsi_its_ivim_ts_msgs/msg/vehicle_characteristics_list.hpp>
namespace ivim_ts_msgs = etsi_its_ivim_ts_msgs::msg;


namespace etsi_its_ivim_ts_conversion {

void toRos_VehicleCharacteristicsList(const ivim_ts_VehicleCharacteristicsList_t& in, ivim_ts_msgs::VehicleCharacteristicsList& out) {
  for (int i = 0; i < in.list.count; ++i) {
    ivim_ts_msgs::CompleteVehicleCharacteristics el;
    toRos_CompleteVehicleCharacteristics(*(in.list.array[i]), el);
    out.array.push_back(el);
  }
}

void toStruct_VehicleCharacteristicsList(const ivim_ts_msgs::VehicleCharacteristicsList& in, ivim_ts_VehicleCharacteristicsList_t& out) {
  memset(&out, 0, sizeof(ivim_ts_VehicleCharacteristicsList_t));
  for (int i = 0; i < in.array.size(); ++i) {
    ivim_ts_CompleteVehicleCharacteristics_t* el = (ivim_ts_CompleteVehicleCharacteristics_t*) calloc(1, sizeof(ivim_ts_CompleteVehicleCharacteristics_t));
    toStruct_CompleteVehicleCharacteristics(in.array[i], *el);
