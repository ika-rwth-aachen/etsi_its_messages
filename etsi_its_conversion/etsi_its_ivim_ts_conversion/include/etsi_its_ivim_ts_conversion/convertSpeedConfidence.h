...
#include <etsi_its_ivim_ts_msgs/msg/speed_confidence.hpp>
namespace ivim_ts_msgs = etsi_its_ivim_ts_msgs::msg;


namespace etsi_its_ivim_ts_conversion {

void toRos_SpeedConfidence(const ivim_ts_SpeedConfidence_t& in, ivim_ts_msgs::SpeedConfidence& out) {
  etsi_its_primitives_conversion::toRos_INTEGER(in, out.value);
}

void toStruct_SpeedConfidence(const ivim_ts_msgs::SpeedConfidence& in, ivim_ts_SpeedConfidence_t& out) {
  memset(&out, 0, sizeof(ivim_ts_SpeedConfidence_t));
