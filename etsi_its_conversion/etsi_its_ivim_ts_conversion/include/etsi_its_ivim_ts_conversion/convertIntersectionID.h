...
#include <etsi_its_ivim_ts_msgs/msg/intersection_id.hpp>
namespace ivim_ts_msgs = etsi_its_ivim_ts_msgs::msg;


namespace etsi_its_ivim_ts_conversion {

void toRos_IntersectionID(const ivim_ts_IntersectionID_t& in, ivim_ts_msgs::IntersectionID& out) {
  etsi_its_primitives_conversion::toRos_INTEGER(in, out.value);
}

void toStruct_IntersectionID(const ivim_ts_msgs::IntersectionID& in, ivim_ts_IntersectionID_t& out) {
  memset(&out, 0, sizeof(ivim_ts_IntersectionID_t));
