...
#include <etsi_its_ivim_ts_msgs/msg/lane_marking_status.hpp>
namespace ivim_ts_msgs = etsi_its_ivim_ts_msgs::msg;


namespace etsi_its_ivim_ts_conversion {

void toRos_LaneMarkingStatus(const ivim_ts_LaneMarkingStatus_t& in, ivim_ts_msgs::LaneMarkingStatus& out) {
  etsi_its_primitives_conversion::toRos_BOOLEAN(in, out.value);
}

void toStruct_LaneMarkingStatus(const ivim_ts_msgs::LaneMarkingStatus& in, ivim_ts_LaneMarkingStatus_t& out) {
  memset(&out, 0, sizeof(ivim_ts_LaneMarkingStatus_t));
