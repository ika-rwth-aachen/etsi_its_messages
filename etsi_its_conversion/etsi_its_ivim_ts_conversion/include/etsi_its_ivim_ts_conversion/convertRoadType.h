...
#include <etsi_its_ivim_ts_msgs/msg/road_type.hpp>
namespace ivim_ts_msgs = etsi_its_ivim_ts_msgs::msg;


namespace etsi_its_ivim_ts_conversion {

void toRos_RoadType(const ivim_ts_RoadType_t& in, ivim_ts_msgs::RoadType& out) {
  out.value = in;
}

void toStruct_RoadType(const ivim_ts_msgs::RoadType& in, ivim_ts_RoadType_t& out) {
  memset(&out, 0, sizeof(ivim_ts_RoadType_t));
  out = in.value;
}
