...
#include <etsi_its_ivim_ts_msgs/msg/vc_class.hpp>
namespace ivim_ts_msgs = etsi_its_ivim_ts_msgs::msg;


namespace etsi_its_ivim_ts_conversion {

void toRos_VcClass(const ivim_ts_VcClass_t& in, ivim_ts_msgs::VcClass& out) {
  etsi_its_primitives_conversion::toRos_INTEGER(in, out.value);
}

void toStruct_VcClass(const ivim_ts_msgs::VcClass& in, ivim_ts_VcClass_t& out) {
  memset(&out, 0, sizeof(ivim_ts_VcClass_t));
