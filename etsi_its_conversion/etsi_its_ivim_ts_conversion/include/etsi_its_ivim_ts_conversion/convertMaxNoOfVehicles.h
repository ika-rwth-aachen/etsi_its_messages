...
#include <etsi_its_ivim_ts_msgs/msg/max_no_of_vehicles.hpp>
namespace ivim_ts_msgs = etsi_its_ivim_ts_msgs::msg;


namespace etsi_its_ivim_ts_conversion {

void toRos_MaxNoOfVehicles(const ivim_ts_MaxNoOfVehicles_t& in, ivim_ts_msgs::MaxNoOfVehicles& out) {
  etsi_its_primitives_conversion::toRos_INTEGER(in, out.value);
}

void toStruct_MaxNoOfVehicles(const ivim_ts_msgs::MaxNoOfVehicles& in, ivim_ts_MaxNoOfVehicles_t& out) {
  memset(&out, 0, sizeof(ivim_ts_MaxNoOfVehicles_t));
