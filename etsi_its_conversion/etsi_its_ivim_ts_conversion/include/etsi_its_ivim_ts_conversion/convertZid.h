...
void toRos_Zid(const ivim_ts_Zid_t& in, ivim_ts_msgs::Zid& out) {
  etsi_its_primitives_conversion::toRos_INTEGER(in, out.value);
}

void toStruct_Zid(const ivim_ts_msgs::Zid& in, ivim_ts_Zid_t& out) {
  memset(&out, 0, sizeof(ivim_ts_Zid_t));
