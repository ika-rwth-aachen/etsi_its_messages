...
#include <etsi_its_ivim_ts_msgs/msg/condition.hpp>
namespace ivim_ts_msgs = etsi_its_ivim_ts_msgs::msg;


namespace etsi_its_ivim_ts_conversion {

void toRos_Condition(const ivim_ts_Condition_t& in, ivim_ts_msgs::Condition& out) {
  etsi_its_primitives_conversion::toRos_INTEGER(in, out.value);
}

void toStruct_Condition(const ivim_ts_msgs::Condition& in, ivim_ts_Condition_t& out) {
  memset(&out, 0, sizeof(ivim_ts_Condition_t));
