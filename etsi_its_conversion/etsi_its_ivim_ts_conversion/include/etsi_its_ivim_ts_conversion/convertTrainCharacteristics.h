...
#include <etsi_its_ivim_ts_msgs/msg/train_characteristics.hpp>
namespace ivim_ts_msgs = etsi_its_ivim_ts_msgs::msg;


namespace etsi_its_ivim_ts_conversion {

void toRos_TrainCharacteristics(const ivim_ts_TrainCharacteristics_t& in, ivim_ts_msgs::TrainCharacteristics& out) {
  toRos_TractorCharacteristics(in, out.value);
}

void toStruct_TrainCharacteristics(const ivim_ts_msgs::TrainCharacteristics& in, ivim_ts_TrainCharacteristics_t& out) {
  memset(&out, 0, sizeof(ivim_ts_TrainCharacteristics_t));
  toStruct_TractorCharacteristics(in.value, out);
}
