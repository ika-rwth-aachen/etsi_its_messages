...
#include <etsi_its_ivim_ts_msgs/msg/ivi_type.hpp>
namespace ivim_ts_msgs = etsi_its_ivim_ts_msgs::msg;


namespace etsi_its_ivim_ts_conversion {

void toRos_IviType(const ivim_ts_IviType_t& in, ivim_ts_msgs::IviType& out) {
  etsi_its_primitives_conversion::toRos_INTEGER(in, out.value);
}

void toStruct_IviType(const ivim_ts_msgs::IviType& in, ivim_ts_IviType_t& out) {
  memset(&out, 0, sizeof(ivim_ts_IviType_t));
