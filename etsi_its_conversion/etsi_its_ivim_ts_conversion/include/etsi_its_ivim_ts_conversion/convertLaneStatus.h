...
#include <etsi_its_ivim_ts_msgs/msg/lane_status.hpp>
namespace ivim_ts_msgs = etsi_its_ivim_ts_msgs::msg;


namespace etsi_its_ivim_ts_conversion {

void toRos_LaneStatus(const ivim_ts_LaneStatus_t& in, ivim_ts_msgs::LaneStatus& out) {
  etsi_its_primitives_conversion::toRos_INTEGER(in, out.value);
}

void toStruct_LaneStatus(const ivim_ts_msgs::LaneStatus& in, ivim_ts_LaneStatus_t& out) {
  memset(&out, 0, sizeof(ivim_ts_LaneStatus_t));
