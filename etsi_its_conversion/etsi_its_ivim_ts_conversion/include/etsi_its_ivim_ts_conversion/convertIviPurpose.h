...
#include <etsi_its_ivim_ts_msgs/msg/ivi_purpose.hpp>
namespace ivim_ts_msgs = etsi_its_ivim_ts_msgs::msg;


namespace etsi_its_ivim_ts_conversion {

void toRos_IviPurpose(const ivim_ts_IviPurpose_t& in, ivim_ts_msgs::IviPurpose& out) {
  etsi_its_primitives_conversion::toRos_INTEGER(in, out.value);
}

void toStruct_IviPurpose(const ivim_ts_msgs::IviPurpose& in, ivim_ts_IviPurpose_t& out) {
  memset(&out, 0, sizeof(ivim_ts_IviPurpose_t));
