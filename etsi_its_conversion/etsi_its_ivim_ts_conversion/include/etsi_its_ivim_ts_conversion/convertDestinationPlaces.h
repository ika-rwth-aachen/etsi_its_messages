...
#include <etsi_its_ivim_ts_conversion/convertDestinationPlace.h>
#include <etsi_its_ivim_ts_msgs/msg/destination_place.hpp>
#include <etsi_its_ivim_ts_msgs/msg/destination_places.hpp>
namespace ivim_ts_msgs = etsi_its_ivim_ts_msgs::msg;


namespace etsi_its_ivim_ts_conversion {

void toRos_DestinationPlaces(const ivim_ts_DestinationPlaces_t& in, ivim_ts_msgs::DestinationPlaces& out) {
  for (int i = 0; i < in.list.count; ++i) {
    ivim_ts_msgs::DestinationPlace el;
    toRos_DestinationPlace(*(in.list.array[i]), el);
    out.array.push_back(el);
  }
}

void toStruct_DestinationPlaces(const ivim_ts_msgs::DestinationPlaces& in, ivim_ts_DestinationPlaces_t& out) {
  memset(&out, 0, sizeof(ivim_ts_DestinationPlaces_t));
  for (int i = 0; i < in.array.size(); ++i) {
    ivim_ts_DestinationPlace_t* el = (ivim_ts_DestinationPlace_t*) calloc(1, sizeof(ivim_ts_DestinationPlace_t));
    toStruct_DestinationPlace(in.array[i], *el);
