...
#include <etsi_its_ivim_ts_conversion/convertAbsolutePosition.h>
#include <etsi_its_ivim_ts_msgs/msg/absolute_position.hpp>
#include <etsi_its_ivim_ts_msgs/msg/absolute_positions.hpp>
namespace ivim_ts_msgs = etsi_its_ivim_ts_msgs::msg;


namespace etsi_its_ivim_ts_conversion {

void toRos_AbsolutePositions(const ivim_ts_AbsolutePositions_t& in, ivim_ts_msgs::AbsolutePositions& out) {
  for (int i = 0; i < in.list.count; ++i) {
    ivim_ts_msgs::AbsolutePosition el;
    toRos_AbsolutePosition(*(in.list.array[i]), el);
    out.array.push_back(el);
  }
}

void toStruct_AbsolutePositions(const ivim_ts_msgs::AbsolutePositions& in, ivim_ts_AbsolutePositions_t& out) {
  memset(&out, 0, sizeof(ivim_ts_AbsolutePositions_t));
  for (int i = 0; i < in.array.size(); ++i) {
    ivim_ts_AbsolutePosition_t* el = (ivim_ts_AbsolutePosition_t*) calloc(1, sizeof(ivim_ts_AbsolutePosition_t));
    toStruct_AbsolutePosition(in.array[i], *el);
