...
#include <etsi_its_ivim_ts_msgs/msg/depth.hpp>
namespace ivim_ts_msgs = etsi_its_ivim_ts_msgs::msg;


namespace etsi_its_ivim_ts_conversion {

void toRos_Depth(const ivim_ts_Depth_t& in, ivim_ts_msgs::Depth& out) {
  etsi_its_primitives_conversion::toRos_INTEGER(in, out.value);
}

void toStruct_Depth(const ivim_ts_msgs::Depth& in, ivim_ts_Depth_t& out) {
  memset(&out, 0, sizeof(ivim_ts_Depth_t));
