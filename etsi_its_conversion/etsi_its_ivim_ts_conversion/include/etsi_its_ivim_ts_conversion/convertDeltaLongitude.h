...
#include <etsi_its_ivim_ts_msgs/msg/delta_longitude.hpp>
namespace ivim_ts_msgs = etsi_its_ivim_ts_msgs::msg;


namespace etsi_its_ivim_ts_conversion {

void toRos_DeltaLongitude(const ivim_ts_DeltaLongitude_t& in, ivim_ts_msgs::DeltaLongitude& out) {
  etsi_its_primitives_conversion::toRos_INTEGER(in, out.value);
}

void toStruct_DeltaLongitude(const ivim_ts_msgs::DeltaLongitude& in, ivim_ts_DeltaLongitude_t& out) {
  memset(&out, 0, sizeof(ivim_ts_DeltaLongitude_t));
