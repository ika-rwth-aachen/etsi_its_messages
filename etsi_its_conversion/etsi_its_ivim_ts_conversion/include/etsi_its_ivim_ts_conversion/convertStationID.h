...
#include <etsi_its_ivim_ts_msgs/msg/station_id.hpp>
namespace ivim_ts_msgs = etsi_its_ivim_ts_msgs::msg;


namespace etsi_its_ivim_ts_conversion {

void toRos_StationID(const ivim_ts_StationID_t& in, ivim_ts_msgs::StationID& out) {
  etsi_its_primitives_conversion::toRos_INTEGER(in, out.value);
}

void toStruct_StationID(const ivim_ts_msgs::StationID& in, ivim_ts_StationID_t& out) {
  memset(&out, 0, sizeof(ivim_ts_StationID_t));
