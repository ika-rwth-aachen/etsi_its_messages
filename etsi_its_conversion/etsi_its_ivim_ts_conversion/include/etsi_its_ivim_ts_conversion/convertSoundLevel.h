...
#include <etsi_its_ivim_ts_msgs/msg/sound_level.hpp>
namespace ivim_ts_msgs = etsi_its_ivim_ts_msgs::msg;


namespace etsi_its_ivim_ts_conversion {

void toRos_SoundLevel(const ivim_ts_SoundLevel_t& in, ivim_ts_msgs::SoundLevel& out) {
  toRos_Int1(in.soundstationary, out.soundstationary);
  toRos_Int1(in.sounddriveby, out.sounddriveby);
}

void toStruct_SoundLevel(const ivim_ts_msgs::SoundLevel& in, ivim_ts_SoundLevel_t& out) {
  memset(&out, 0, sizeof(ivim_ts_SoundLevel_t));
  toStruct_Int1(in.soundstationary, out.soundstationary);
  toStruct_Int1(in.sounddriveby, out.sounddriveby);
}
