...
void toRos_LateralAcceleration(const LateralAcceleration_t& in, etsi_its_cam_msgs::LateralAcceleration& out) {
  ...
  toRos_LateralAccelerationValue(in.lateral_acceleration_value, out.lateral_acceleration_value);
  toRos_AccelerationConfidence(in.lateral_acceleration_confidence, out.lateral_acceleration_confidence);
}
...
void toStruct_LateralAcceleration(const etsi_its_cam_msgs::LateralAcceleration& in, LateralAcceleration_t& out) {
  ...
  toStruct_LateralAccelerationValue(in.lateral_acceleration_value, out.lateral_acceleration_value);
  toStruct_AccelerationConfidence(in.lateral_acceleration_confidence, out.lateral_acceleration_confidence);
}
