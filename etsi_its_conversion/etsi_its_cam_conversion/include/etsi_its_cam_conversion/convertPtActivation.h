...
void toRos_PtActivation(const PtActivation_t& in, etsi_its_cam_msgs::PtActivation& out) {
  ...
  toRos_PtActivationType(in.pt_activation_type, out.pt_activation_type);
  toRos_PtActivationData(in.pt_activation_data, out.pt_activation_data);
}
...
void toStruct_PtActivation(const etsi_its_cam_msgs::PtActivation& in, PtActivation_t& out) {
  ...
  toStruct_PtActivationType(in.pt_activation_type, out.pt_activation_type);
  toStruct_PtActivationData(in.pt_activation_data, out.pt_activation_data);
}
